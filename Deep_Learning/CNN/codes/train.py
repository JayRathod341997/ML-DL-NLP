...
from model import CNN, count_parameters, get_device
...
def train(
    ...
    scheduler = optim.lr_scheduler.ReduceLROnPlateau(
        optimizer,
        mode="max" if val_loader else "max",
...
def main() -> None:
    ...
    parser.add_argument("--input-channels", type=int, default=1, help="Input channels")
